...
import android.widget.AdapterView.OnItemLongClickListener;
	...
	public class NeedNGOActivity extends Activity {
...
//			String url="http://careersociety.in/UploadWeb/GetAllNGOServices";
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					...
					Intent i=new Intent(NeedNGOActivity.this, NeedNgoDetailsActivity.class);
					i.putExtra("NGO",ngo);
					startActivity(i);
		...
		class GetAllNGOTask extends AsyncTask<String, Void, String> {
			...
			protected void onPreExecute() {
				...
				pd = new ProgressDialog(NeedNGOActivity.this);
			...
			protected void onPostExecute(String result) {
				...
				Log.v("Need NGO Activity Result = ", result.toString());
				//[{"id":1,"name":"ayush","desc":"mp nagar","link":"spring.com","need":"b-10,b-11","address":"b-10,b-11"}]
				
			//	Toast.makeText(NeedNGOActivity.this, result, 2).show();
				try {
	...
	//				Toast.makeText(NeedNGOActivity.this, e.toString(), 2)
		//					.show();
				}
