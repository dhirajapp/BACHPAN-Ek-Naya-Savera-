...
public class NGO_ListActivity extends Activity {
...
//		String url="http://careersociety.in/UploadWeb/GetAllNGOServices";
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent i=new Intent(NGO_ListActivity.this, NgoDetailsActivity.class);
				i.putExtra("NGO",ngo);
				startActivity(i);
	...
	class GetAllNGOTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			...
			pd = new ProgressDialog(NGO_ListActivity.this);
		...
		protected void onPostExecute(String result) {
			...
			Log.v("NGO List result : ", result.toString());
			//[{"id":1,"name":"ayush","desc":"mp nagar","link":"spring.com","need":"b-10,b-11","address":"b-10,b-11"}]
			
		//	Toast.makeText(NGO_ListActivity.this, result, 2).show();
			try {
		...
		//		Toast.makeText(NGO_ListActivity.this, e.toString(), 2)
			//			.show();
			}
